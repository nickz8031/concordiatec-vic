...
public class CustomProgressBar extends View {
    ...
    public CustomProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = a.getDimension(R.styleable.CustomProgressBar_borderWidth,
                DEFAULT_BORDER_WIDTH * density);
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(R.color.theme_color);
        mColors[1] = context.getResources().getColor(R.color.theme_color);
        mColors[2] = context.getResources().getColor(R.color.theme_color);
        mColors[3] = context.getResources().getColor(R.color.theme_color);
    ...
    private Property<CustomProgressBar, Float> mAngleProperty = new Property<CustomProgressBar, Float>(Float.class, "angle") {
        @Override
        public Float get(CustomProgressBar object) {
            return object.getCurrentGlobalAngle();
        }

        @Override
        public void set(CustomProgressBar object, Float value) {
            object.setCurrentGlobalAngle(value);
        }
    };

    private Property<CustomProgressBar, Float> mSweepProperty = new Property<CustomProgressBar, Float>(Float.class, "arc") {
        @Override
        public Float get(CustomProgressBar object) {
