...
public class TagView extends TextView {
    ...
    public void setSingleTag( Tag tag ){
    	if( tag == null ){
    		this.setVisibility(View.GONE);
            return;
    	}
    ...
    public int getTagPaddingHor() {
		return tagPaddingHor;
	}

	public void setTagPaddingHor(int tagPaddingHor) {
		this.tagPaddingHor = tagPaddingHor;
	}

	public int getTagPaddingVert() {
		return tagPaddingVert;
	}

	public void setTagPaddingVert(int tagPaddingVert) {
		this.tagPaddingVert = tagPaddingVert;
	}
