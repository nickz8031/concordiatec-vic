...
public class ObservableListView extends ListView implements ObScrollable {
    ...
    private ObScrollState mScrollState;
            ...
            if (getChildCount() > 0) {
                ...
                if (firstVisibleChild != null) {
                    ...
                    if (mPrevScrollY < mScrollY) {
                        //down
                        mScrollState = ObScrollState.UP;
                    } else if (mScrollY < mPrevScrollY) {
                        //up
                        mScrollState = ObScrollState.DOWN;
                    } else {
                        mScrollState = ObScrollState.STOP;
                    }
