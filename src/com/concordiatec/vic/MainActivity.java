...
public class MainActivity extends BaseSherlockFragmentActivity {
	...
	// tab underline
	private int[] tabLineIds = { R.id.tab_active_line_1,
			R.id.tab_active_line_2, R.id.tab_active_line_3 };
	// tab
	private int[] tabIds = { R.id.main_tab_select_1, R.id.main_tab_select_2,
			R.id.main_tab_select_3 };
	...
	private void initPages() {
		...
		mainVp.setAdapter(new MainVpAdapter(getSupportFragmentManager(),
				viewPagerViews));
