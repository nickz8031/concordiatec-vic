...
public class Article extends VicModel implements Serializable {
	...
	public String toString() {
		return "Article [id=" + id + ", kind=" + kind + ", effectId=" + effectId + ", content=" + content + ", pastTime=" + pastTime + ", writerId=" + writerId + ", writerIsShop=" + writerIsShop + ", writerShopId=" + writerShopId + ", writerName=" + writerName + ", writerPhotoURL=" + writerPhotoURL + ", coverImageURL=" + coverImageURL + ", coverImageWidth=" + coverImageWidth + ", coverImageHeight=" + coverImageHeight + ", images=" + images + ", shopId=" + shopId + ", shopName=" + shopName + ", shopAddr=" + shopAddr + ", shopGroupId=" + shopGroupId + ", likeCount=" + likeCount + ", shareCount=" + shareCount + ", commentCount=" + commentCount + ", latestComments=" + latestComments + ", isLike=" + isLike + ", allowComment=" + allowComment + ", minHeight=" + minHeight + "]";
	}
	/**
	 * article id
	 */
